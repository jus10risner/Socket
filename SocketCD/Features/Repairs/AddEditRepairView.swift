...
struct AddEditRepairView: View {
    ...
    var body: some View {
        NavigationStack {
            Form {
                FormHeaderView(symbolName: "wrench.adjustable.fill", primaryText: repair != nil ? "Edit Repair" : "New Repair", accentColor: Color.repairsTheme)
                ...
                FormFooterView (
                    ...
                    documents: $draftRepair.documents,
