...
enum AppIcon: String, CaseIterable {
    case inverted = "Inverted", monochrome = "Monochrome", classic = "Socket Classic", dark = "Dark", light = "Light", darkMonochrome = "Dark Monochrome", lightMonochrome = "Light Monochrome"
